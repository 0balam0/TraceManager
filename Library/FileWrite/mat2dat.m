...
switch nargin
    ...
    case 2
        ...
        if isstruct(varargin{1})
            ...
            % filename
            [pathIn, fileIn, extIn] = fileparts(varargin{1});
            raw = load(fullfile(pathIn, [fileIn, extIn]));
        end
        [pathOut, fileOut, extOut] = fileparts(varargin{2});
        writeDatFile(raw, [fileOut, extOut], [pathOut,'\']);
end
