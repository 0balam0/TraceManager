...
paramFile = fopen(['outParam_' sModel '.cfg'], 'w');
...
hMux=add_block(NewHandle,[sTop_level_block,'/Mux_out'], 'Position', [100 20 110 30]); %out

hOut_mux=add_block('built-in/ToWorkspace',[sTop_level_block,'/M_out'], 'Position', [200 20 260 60],...
    'VariableName', 'M_out', 'SaveFormat', 'StructureWithTime', 'MaxDataPoints', 'Inf'); %To connect the MUX to OUTPUT
