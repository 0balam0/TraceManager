...
try
   ...
   handles = creaOggetti(handles, bForceZero);
...
function handles = creaOggetti(handles, bForceZero)
     ...
     hAssi(iAx) = hA;
      ...
      for j = 1:L1
         ...
         for k = 1:length(tAx)
            ...
            set(hL, 'Color',vColore, 'LineWidth',vWidth, 'LineStyle',vStyle, 'MarkerEdgeColor',vColore, 'MarkerFaceColor',vColore, 'MarkerSize',4,...
...
function setPosizioniAssi(hObject, eventdata, handles)
